...
-- alter table aq_brand add smalllogo varchar(50) not null default '' comment '品牌logo缩略图';
-- alter table aq_brand add stamplogo varchar(50) not null default '' comment '品牌logo水印图';
...
insert into aq_admin(admin_name,password,email) values('admin',md5('123'),'admin@qq.cn');
